...
const Tips = () => {
  return (
    <div className='lg:px-40 md:px-12 sm:px8 flex flex-col lg:flex-row  gap-x-8 font-[Nunito-Sans] font-medium'>
      <aside className='md:w-[47.3125rem] mx-auto'>
        ...
        <h2 className='my-6 px-4 md:px-0'>1. Get to know your audience</h2>
        <div className='px-4 md:px-0'>
          <p>
        ...
        <h2 className='my-6 px-4 md:px-0'>
      ...
      <aside className='md:w-[22.9375rem] flex flex-col mt-10 mx-auto  gap-y-6'>
        <div className='bg-cyan-100 px-6 mx-4 md:mx-0 gap-y-4 py-4 rounded-xl flex flex-col justify-center'>
          <Image
            alt='/'
            width={208.17}
            height={203}
        ...
        <div className=' bg-cyan-100 px-6 mx-4 md:mx-0 py-4 gap-y-4 rounded-xl flex flex-col justify-center'>
          <Image
            alt='/'
            width={208.17}
            height={203}
