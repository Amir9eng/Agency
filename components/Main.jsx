...
const Main = () => {
  return (
    <section className='w-full bg-cyan-100 py-12 px-20 justify-between items-center flex  flex-col md:flex-row gap-x-[5.7rem] '>
      <div className='md:max-w-[31.75rem] py-10 px-2  '>
        ...
        <div className=' py-8 leading-8'>
          <p className='w-[20rem] font-semibold leading-2 max-w-[30.5rem]'>
      ...
      <div className='grid grid-cols-2 h-[29.3125rem] relative '>
        ...
        <div className='w-[9.25rem] h-[12.93rem] md:w-[19.83rem] md:h-[27.8rem]'>
          <Image
            alt='/'
        ...
        <div className='absolute left-[8rem] md:left-[17.625rem] '>
          <Board />
        </div>
      </div>
    </section>
