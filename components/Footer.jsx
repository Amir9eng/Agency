...
const Footer = () => {
  return (
    <section className='bg-black  mx-auto py-12'>
      <div className='flex justify-between px-48 lg:flex-row flex-col'>
      ...
      <div className='flex lg:flex-row flex-col justify-around gap-x-8 my-6 px-64 mx-auto lg:text-left md:text-center gap-y-6'>
      ...
      <div className='flex lg:flex-row flex-col flex-col-reverse justify-between px-48 mt-6'>
